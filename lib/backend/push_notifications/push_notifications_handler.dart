...
final parametersBuilderMap =
  ...
  'userAssets': (data) async => ParameterData(
        allParams: {
          'assets': await getDocumentParameter<UsersRecord>(
              data, 'assets', UsersRecord.fromSnapshot),
        },
      ),
  'AllPlayersCXT': ParameterData.none(),
  'Transactions': ParameterData.none(),
  'NotificationDownload': ParameterData.none(),
  'viewHatch': (data) async => ParameterData(
        allParams: {
          'userDetails': await getDocumentParameter<UsersRecord>(
              data, 'userDetails', UsersRecord.fromSnapshot),
        },
