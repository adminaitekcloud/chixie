                            ...
                            Expanded(
                              child: TextFormField(
                                controller: _model.yourSponsorController ??=
                                    TextEditingController(
                                  text: valueOrDefault<String>(
                                    editUserProfileUsersRecord.sponsorId
                                        .toString(),
                                    '123456',
                                  ),
                                ),
                                ...
                                validator: _model.yourSponsorControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ],
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: _model.userPhoneControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
