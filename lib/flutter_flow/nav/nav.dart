...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/settingsNew',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'SettingsNew')
              : SettingsNewWidget(),
        ),
        FFRoute(
          name: 'MainHome',
        ...
        FFRoute(
          name: 'TalktoChixie',
          path: '/talktoChixie',
          builder: (context, params) => TalktoChixieWidget(),
        ),
        FFRoute(
          name: 'userAssets',
          path: '/userAssets',
          asyncParams: {
            'assets': getDoc(['users'], UsersRecord.fromSnapshot),
          },
          builder: (context, params) => UserAssetsWidget(
            assets: params.getParam('assets', ParamType.Document),
          ),
        ),
        FFRoute(
          name: 'AllPlayersCXT',
          path: '/allPlayersCXT',
          builder: (context, params) => AllPlayersCXTWidget(),
        ),
        FFRoute(
          name: 'Transactions',
          path: '/transactions',
        ...
        FFRoute(
          ...
          path: '/notificationDownload',
          builder: (context, params) => NotificationDownloadWidget(),
        ),
        FFRoute(
          name: 'viewHatch',
          path: '/viewHatch',
          ...
          builder: (context, params) => ViewHatchWidget(
            userDetails: params.getParam('userDetails', ParamType.Document),
          ),
        ),
        FFRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      'assets/images/Untitled_(250__250px).png',
                      width: 350.0,
                      fit: BoxFit.cover,
                    ),
                  ),
