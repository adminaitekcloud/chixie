...
import '/components/empty_listno_eggothers/empty_listno_eggothers_widget.dart';
...
import 'view_hatch_model.dart';
export 'view_hatch_model.dart';

class ViewHatchWidget extends StatefulWidget {
  const ViewHatchWidget({
    Key? key,
    this.userDetails,
  }) : super(key: key);
  ...
  @override
  _ViewHatchWidgetState createState() => _ViewHatchWidgetState();
}

class _ViewHatchWidgetState extends State<ViewHatchWidget>
    with TickerProviderStateMixin {
  late ViewHatchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewHatchModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final viewHatchUsersRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
          appBar: AppBar(
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        viewHatchUsersRecord.displayName,
                                        'UserName',
                                      ),
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        viewHatchUsersRecord.cxt.toString(),
                                        textAlign: TextAlign.start,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                    ...
                                    context.pushNamed(
                                      ...
                                      queryParameters: {
                                        'chatUser': serializeParam(
                                          viewHatchUsersRecord,
                                          ParamType.Document,
                                        ),
                                      }.withoutNulls,
                                      extra: <String, dynamic>{
                                        'chatUser': viewHatchUsersRecord,
                                      },
                                    );
                                  },
                                  text: 'Message',
                                ...
                                stream: queryDogsRecord(
                                  queryBuilder: (dogsRecord) =>
                                      dogsRecord.where('userAssociation',
                                          isEqualTo:
                                              viewHatchUsersRecord.reference),
                                ),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                  ...
                                  if (columnDogsRecordList.isEmpty) {
                                    return EmptyListnoEggothersWidget();
                                  }
                                  return Column(
                                    mainAxisSize: MainAxisSize.max,
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ClipRRect(
                                                ...
                                                child: Image.network(
                                                  'https://firebasestorage.googleapis.com/v0/b/wiwa-2023.appspot.com/o/egg.png?alt=media&token=ebe85c13-c263-41f3-9bca-53489ee3a2bd',
                                                  width: 100.0,
                                                  height: 100.0,
                                                  fit: BoxFit.cover,
                                                ),
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        0.0),
                                                            child: Text(
                                                              'on ${columnDogsRecord.hatchDate?.toString()}',
