...
import '/components/modal_assets/modal_assets_widget.dart';
...
import 'members_all_model.dart';
export 'members_all_model.dart';

class MembersAllWidget extends StatefulWidget {
  const MembersAllWidget({Key? key}) : super(key: key);

  @override
  _MembersAllWidgetState createState() => _MembersAllWidgetState();
}

class _MembersAllWidgetState extends State<MembersAllWidget> {
  late MembersAllModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MembersAllModel());
