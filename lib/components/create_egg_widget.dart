...
import 'create_egg_model.dart';
export 'create_egg_model.dart';

class CreateEggWidget extends StatefulWidget {
  const CreateEggWidget({Key? key}) : super(key: key);

  @override
  _CreateEggWidgetState createState() => _CreateEggWidgetState();
}

class _CreateEggWidgetState extends State<CreateEggWidget>
    with TickerProviderStateMixin {
  late CreateEggModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateEggModel());
